...
# **Estructura del código**
  La estructura del código tanto de terminal como de interfaz se puede encontrar en el siguiente [documento](https://github.com/UCM-FDI-DISIA/project-tres_gp/blob/main/4EnRayaFURY.txt)
